document.addEventListener('DOMContentLoaded',() => {
  ...
  function rotate() {
    undraw()
    currentRotation ++
    if(currentRotation === current.length){//if the current rotat gets to 4,make it go to 0
      currentRotation = 0
    }
    current = theTetrominoes[random][currentRotation]
    draw()
  ...
  //the Tetramino without rotation
  ...
  function displayShape() {
    //remove any trace of a tetramino form the entire grid
